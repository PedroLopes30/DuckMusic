...
from api.depends.musics_dep import FavoritesMusicsRepositoryDep , MusicRepositoryDep
from api.depends.auth_dep import UserDep

from api.shemas.output.music_output import MusicListResponse
from api.shemas.output.general_output import DetailResponse

from api.models import FavoritesMusics
